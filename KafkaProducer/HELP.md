...
* The original package name 'example.kafka-producer' is invalid and this project uses 'example.kafka_producer' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/3.5.10/reference/messaging/kafka.html)
